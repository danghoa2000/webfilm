<%@ Page Title="" Language="C#" MasterPageFile="~/client/client.Master" AutoEventWireup="true" CodeBehind="gio_phim.aspx.cs" Inherits="phim.client.gio_phim" %>
		...
		<div class="row">
			<div class="col-md-12" style="padding-top:190px">
				...
				<ul class="breadcumb">
					...
					<li> <span class="ion-ios-arrow-right"></span> Giỏ Phim</li>
				</ul> 
			</div>
		</div>
	</div>
				...
				<div class="flex-wrap-movielist">
					...
					<ItemTemplate>	
						<div class="movie-item-style-2 movie-item-style-1">
							...
							<div class="hvr-inner" style="margin-top: 90px ; margin-left:38px; background-color: #d3b200 ; width: 90px;padding:8px 5px">
                                <asp:Button ID="add" runat="server" Text="Remove" CssClass="btadd" OnCommand="add_Command" CommandArgument='<%# Eval("id_phim") %>'/>
