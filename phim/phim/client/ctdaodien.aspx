<%@ Page Title="" Language="C#" MasterPageFile="~/client/client.Master" AutoEventWireup="true" CodeBehind="ctdaodien.aspx.cs" Inherits="phim.client.WebForm5" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="js" runat="server">
	<script>
		...
		$.ajax({
            type: 'GET',
            url: 'http://localhost:63639/api/daodiens/' + $('#url').text(),
            dataType: 'json',
			success: function (data) {
                ...
                var $ten = $('#ten');
				var $list = $('#phim');
                $('<img src="../admin/image/' + data.img + '" >').appendTo($blog)
                ...
                $.each(data.ctDienvien, function (index, x) {
                    $(
                        ...
                        '<img src="../admin/igame/' + x.phim.anh_daidien + '" alt="">' +
                        '<div>' +
