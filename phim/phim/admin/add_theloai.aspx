<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="add_theloai.aspx.cs" Inherits="phim.admin.add_theloai" %>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <div class="form-horizontal style-form" >
                  ...
                  <label class="col-sm-2 col-sm-2 control-label" >thể loại phim</label>
                  <div class="col-sm-10">
