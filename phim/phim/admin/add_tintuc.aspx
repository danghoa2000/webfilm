<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="add_tintuc.aspx.cs" Inherits="phim.admin.add_tintuc" %>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <div class="form-horizontal style-form" >
                  ...
                  <div class="col-sm-10">
                  <asp:TextBox ID="tieude" runat="server" CssClass="form-control" required></asp:TextBox>
                  </div>
                </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                        <asp:TextBox ID="tomtat" runat="server" class="form-control" TextMode="multiline" required></asp:TextBox>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="ccomment" class="control-label col-lg-2">nội dung</label>
                    <div class="col-lg-10">
                        <asp:TextBox ID="noidung" runat="server" class="form-control" TextMode="multiline" required></asp:TextBox>
                    </div>
                  </div>
                  <div class="form-group">
