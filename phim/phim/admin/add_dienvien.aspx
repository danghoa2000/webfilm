<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="add_dienvien.aspx.cs" Inherits="phim.admin.add_dienvien" %>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <div class="form-horizontal style-form" >
                  ...
                  <label class="col-sm-2 col-sm-2 control-label" >tên diễn viên</label>
                  <div class="col-sm-10">
